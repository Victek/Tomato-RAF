...
Currently available applets include:
	...
	rmdir, rmmod, route, sed, sendmail, setconsole, sh, sleep, sort,
	strings, swapoff, swapon, sync, syslogd, tail, tar, telnet, telnetd,
	test, top, touch, tr, traceroute, traceroute6, true, tune2fs,
	tune2fs, udhcpc, umount, uname, unzip, uptime, usleep, vconfig, vi,
	watch, wc, wget, which, zcat
