...
function ethstates()
{
	...
	var code = '<div class="section-title">Ethernet Status</div>';
	code += '<table class="fields"><tr><td class="title indent2"><center><b>WAN</b></center></td><td><center><b>LAN 1</b></center></td><td><center><b>LAN 2</b></center></td><td><center><b>LAN 3</b></center></td><td><center><b>LAN 4</b></center></td><tr>';
	...
	if (stats.lan_desc == '1') {
		code += '<td width="21%"><center>' + state + state2 + '</center></td>';
	} else {
		code += '<td width="21%"><center>' + state + '</center></td>';
	}
	...
	if (stats.lan_desc == '1') {
		code += '<td width="17%"><center>' + state + state2 + '</center></td>';
	} else {
		code += '<td width="17%"><center>' + state + '</center></td>';
	}
...
createFieldTable('', [
	...
	{ title: 'CPU Clock', text: stats.cpumhz },
	{ title: 'CPU Load', rid: 'cpupercent', text: stats.cpupercent },
