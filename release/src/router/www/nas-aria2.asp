...
<title>[<% ident(); %>] Aria2 Client</title>
...
<script type='text/javascript'>
createFieldTable('', [
	{ title: 'Enable Service', name: 'f_aria2_enable', type: 'checkbox', value: nvram.aria2_enable == '1' },
	{ title: 'Listening port', name: 'aria2_port', type: 'text', maxlen: 5, size: 7, value: nvram.aria2_port > 0 ? nvram.aria2_port : 6881 },
	{ title: 'Download directory', name: 'aria2_dir', type: 'text', maxlen: 40, size: 40, value: nvram.aria2_dir }
]);
</script>
<script type='text/javascript'>
createFieldTable('', [
	{ title: 'Listening RPC port', name: 'aria2_port_rpc', type: 'text', maxlen: 32, size: 5, value: nvram.aria2_port_rpc > 0 ? nvram.aria2_port_rpc : 6800 },
	{ title: 'SSL to Encrypt RPC traffic', name: 'f_aria2_ssl_rpc', type: 'checkbox', value: (nvram.aria2_ssl_rpc != '0') },
	{ title: 'Save settings', name: 'aria2_settings', type: 'select', options: [
...
/* CIFS-END */
			['/tmp','RAM (Temporary)']], value: nvram.aria2_settings },
    null,
